...
$sql_edit = "SELECT * FROM tblseries WHERE series_ID = '".$_POST['SeriesId']."'";
  ...
  <!--<div class="form-group">
    ...
    <div class="form-group">
      <label class="control-label col-md-3 col-sm-3 col-xs-12">Name</label>
        <div class="col-md-7 col-sm-7 col-xs-12">
          <input type='text' class="form-control" id="edit_series_name" placeholder="Please enter the name" maxlength="200" value="<?php echo $row_edit['series_Name']; ?>"/>
        </div>
      </div>
      ...
      <div class="form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12">Chipset</label>
          <div class="col-md-7 col-sm-7 col-xs-12">
            <select class="form-control" id="edit_series_chip">
              <option value="0"> # Select Chipset # </option>
                ...
                <option value="<?php echo $rowchipset['chipset_ID']; ?>"
                  <?php if ($rowchipset['chipset_ID'] == $row_edit['series_IDchipset']) {
      ...
      <div class="form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12">Status</label>
          <div class="col-md-7 col-sm-7 col-xs-12">
            <input type="radio" name="status" id="edit_series_status1" <?php if ($row_edit['series_Status'] == '1') { echo "checked";} ?> value="1"> Active
            &nbsp&nbsp&nbsp&nbsp&nbsp
            <input type="radio" name="status" id="edit_series_status0" <?php if ($row_edit['series_Status'] == '0') { echo "checked";} ?> value="0"> InActive
          </div>
      </div>
      ...
      <!-- <div class="form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12">Type</label>
          <div class="col-md-7 col-sm-7 col-xs-12">
            <select class="form-control" id="add_series_type">
