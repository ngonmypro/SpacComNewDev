<?php include "../../../../connect/connect_mysql.php"; ?>
 ...
 $('#busramtb tfoot th').each( function () {
   var title = $(this).text();
 ...
 $('#busramtb').DataTable().columns().every( function () {
   var that = this;
   //ค้นหาจาก footer
 ...
 function OpenAdminAddForm(){
    ...
    <button type="button" class="btn btn-success" onClick="javascript:AddBusram('add');"><i class="glyphicon glyphicon-plus"></i> Add</button>

 <table id="busramtb" class="display" cellspacing="0" width="100%"> <!--display nowrap-->
     <thead>
         <tr>
     ...
     <?php $rowint = 1;
      $sql_busram = " SELECT busram_ID, busram_IDtyperam, busram_Name, busram_Status, typeram_Name FROM tblbusram
     ...
     ?>
         <tr style="cursor:pointer;">
             ...
             <td style="font-size:16px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row_busram['busram_Name'];?></td>
             <td style="font-size:16px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row_busram['typeram_Name'];?></td>
             <td style="font-size:16px; text-align:center;"><?php if ($row_busram['busram_Status'] == 1) {
               echo "Active";
             }else {
               echo "Inactive";
             }?></td>
             <td style="text-align:center;">
               <button type="button" class="btn btn-warning btn-xs" onClick="javascript:EditBusram('<?php echo $row_busram['busram_ID'];?>','edit');"><i class="glyphicon glyphicon-cog"></i> Edit</button>
               <button type="button" class="btn btn-danger btn-xs" onClick="javascript:DelBusram('<?php echo $row_busram['busram_ID'];?>','<?php echo $row_busram['busram_Name'];?>','delete');"><i class="glyphicon glyphicon-trash"></i> Delete</button>
             </td>
         </tr>
       <?php $rowint = $rowint + 1;
       } //while ?>
